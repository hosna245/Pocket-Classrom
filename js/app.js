...
navButtons.library.addEventListener('click', () => setActiveNav('library'));
navButtons.author.addEventListener('click', () => setActiveNav('author'));
navButtons.learn.addEventListener('click', () => setActiveNav('learn'));
